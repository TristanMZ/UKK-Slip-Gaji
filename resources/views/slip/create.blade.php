...
@section('content')
    <div class="section-heading">
        <div>
            ...
            <div class="desc">Masukkan NIK karyawan, lalu lengkapi rincian penghasilan dan potongan.</div>
        </div>
        ...
        <form method="POST" action="{{ route('slip.store') }}">
            ...
            <div class="field @error('jabatan') has-error @enderror">
                ...
                <input type="text" id="jabatan" name="jabatan" value="{{ old('jabatan') }}"
                    placeholder="Contoh: Staff Administrasi" maxlength="100" required>
            </div>
            ...
            <div class="field-row">
                <div class="field @error('periode_awal') has-error @enderror">
                    ...
                    <input type="date" id="periode_awal" name="periode_awal" value="{{ old('periode_awal') }}" required>
                </div>
                <div class="field @error('periode_akhir') has-error @enderror">
                    <label for="periode_akhir">Periode akhir</label>
                    <input type="date" id="periode_akhir" name="periode_akhir" value="{{ old('periode_akhir') }}"
                        required>
                </div>
            </div>
            ...
            <button type="submit" class="btn btn-primary btn-block">Hitung &amp; simpan slip gaji</button>
        </form>
    </div>
@endsection
